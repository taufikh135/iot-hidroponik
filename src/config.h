...
namespace MqttConfig {
    const char* SERVER = "b68d382ffcfb4364a0cb68b2cb98d90d.s1.eu.hivemq.cloud";
    const int PORT = 8883;
    const char* USERNAME = "esp32"; // Ganti dengan username Anda
    const char* PASSWORD = "Esp32mqtt"; // Ganti dengan password Anda
